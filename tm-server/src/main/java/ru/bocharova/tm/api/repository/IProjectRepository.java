...
public interface IProjectRepository {
    ...
    @Nullable String INSERT = "INSERT into app_project(id, name, description, dateBegin, dateEnd, status, user_id) VALUES (#{id}, #{name}, #{description}, #{dateBegin}, #{dateEnd}, #{status}, #{userId})";
