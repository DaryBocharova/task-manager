...
public interface IProjectRepository {
    ...
    Collection<Project> findAllByUserId(@NotNull final User user);
    ...
    Collection<Project> findAllByPartOfNameOrDescription(@NotNull final String name, @NotNull final String description,
