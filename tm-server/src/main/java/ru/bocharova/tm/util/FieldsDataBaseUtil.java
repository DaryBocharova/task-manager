...
public class FieldsDataBaseUtil {
    @NotNull public static final String ID = "id";
    @NotNull public static final String NAME = "name";
    @NotNull public static final String DATEBEGIN = "dateBegin";
    @Nullable
    public static final String DATEEND = "dateEnd";
    @NotNull public static final String DESCRIPTION = "description";
    @NotNull public static final String USERID = "‘user_id";
    @NotNull public static final String PROJECTID = "project_id";
