...
public class IUserEndpointImpl implements IUserEndpoint {
  ...
  public IUserEndpointImpl(String host, int port, javax.xml.ws.WebServiceFeature... features) {
    this.proxy = javax.xml.ws.spi.Provider.provider().createServiceDelegate(getClass().getResource("/ns0.wsdl"), new javax.xml.namespace.QName("http://endpoint.api.tm.bocharova.ru/", "IUserEndpointService"), javax.xml.ws.Service.class).getPort(IUserEndpoint.class, features);
    try {
