...
public class ITaskEndpointImpl implements ITaskEndpoint {
  ...
  public ITaskEndpointImpl(String host, int port, javax.xml.ws.WebServiceFeature... features) {
    this.proxy = javax.xml.ws.spi.Provider.provider().createServiceDelegate(getClass().getResource("/ns0.wsdl"), new javax.xml.namespace.QName("http://endpoint.api.tm.bocharova.ru/", "ITaskEndpointService"), javax.xml.ws.Service.class).getPort(ITaskEndpoint.class, features);
    try {
