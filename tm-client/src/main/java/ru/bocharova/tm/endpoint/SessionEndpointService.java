...
public class SessionEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.bocharova.ru/", "SessionEndpointService");
    public final static QName SessionEndpointPort = new QName("http://endpoint.tm.bocharova.ru/", "SessionEndpointPort");
    static {
        URL url = null;
        try {
    ...
    public @org.jetbrains.annotations.NotNull SessionEndpoint getSessionEndpointPort() {
