...
public class TaskEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.bocharova.ru/", "TaskEndpointService");
    public final static QName TaskEndpointPort = new QName("http://endpoint.tm.bocharova.ru/", "TaskEndpointPort");
    static {
        URL url = null;
        try {
    ...
    public @org.jetbrains.annotations.NotNull TaskEndpoint getTaskEndpointPort() {
