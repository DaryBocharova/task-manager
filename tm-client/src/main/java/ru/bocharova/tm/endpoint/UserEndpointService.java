...
public class UserEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.bocharova.ru/", "UserEndpointService");
    public final static QName UserEndpointPort = new QName("http://endpoint.tm.bocharova.ru/", "UserEndpointPort");
    static {
        URL url = null;
        try {
    ...
    public @org.jetbrains.annotations.NotNull UserEndpoint getUserEndpointPort() {
