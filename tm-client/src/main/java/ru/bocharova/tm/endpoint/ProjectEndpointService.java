 ...
 * 2019-07-11T16:26:48.468+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "ProjectEndpointService",
                  wsdlLocation = "http://localhost:80/ProjectEndpoint?wsdl",
                  targetNamespace = "http://endpoint.tm.bocharova.ru/")
public class ProjectEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.tm.bocharova.ru/", "ProjectEndpointService");
    public final static QName ProjectEndpointPort = new QName("http://endpoint.tm.bocharova.ru/", "ProjectEndpointPort");
    static {
        URL url = null;
        try {
    ...
    public @org.jetbrains.annotations.NotNull ProjectEndpoint getProjectEndpointPort() {
